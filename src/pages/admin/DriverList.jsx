...
const DriverList = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (!emailRegex.test(formData.email)) {
      toast.error('Geçerli bir e-posta adresi girin!', { position: "top-right", autoClose: 4000, hideProgressBar: true, closeOnClick: true, pauseOnHover: false, style: { backgroundColor: "#f44336", color: "white", fontSize: "14px", fontWeight: "500" } });
      return;
    }
